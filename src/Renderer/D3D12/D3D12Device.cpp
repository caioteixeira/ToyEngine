...
GraphicsTexturePtr D3D12GraphicsDevice::CreateTextureFromFile(const char* inFileName, int& outWidth,
                                                              int& outHeight) const
{
    ...
    ComPtr<ID3D12DescriptorHeap> descriptorHeap = CreateDescriptorHeap(D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV,
